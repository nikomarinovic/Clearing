...
/** Every OCR language bundled with the app — always loaded together so receipts in any of these languages read correctly, without asking the user to pick. */
export const ALL_OCR_LANGUAGES: OcrLanguageCode[] = OCR_LANGUAGES.map((l) => l.code);
...
export async function scanReceipt(
  image: File | Blob,
  languages: OcrLanguageCode[] = ALL_OCR_LANGUAGES,
