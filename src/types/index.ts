...
import type { OcrLanguageCode } from "../lib/receiptScan";

export type CardStyle = "forest" | "midnight" | "sunset" | "mono" | "ocean" | "rose";

/** Structural/layout preset for the balance card, independent of color. */
export type CardDesign = "premium" | "aurora" | "carbon" | "classic" | "minimal";
...
export interface AppSettings {
  ...
  /** Languages Tesseract loads together when scanning a receipt. */
