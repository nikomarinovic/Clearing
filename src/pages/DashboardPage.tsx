...
import { Wallet, TrendingUp, ShieldCheck, Plus, Target, ArrowDownLeft, ArrowUpRight, Zap, Info } from "lucide-react";
...
export default function DashboardPage() {
  ...
  return (
    <div className="pb-6">
      ...
      <Card className="mb-4 overflow-hidden sm:mb-5 bg-gradient-to-b from-[var(--surface)] to-[var(--surface)]">
        <div className="flex flex-col gap-1">
          <span className="flex items-center gap-1.5 text-[13px] font-medium text-[var(--text-muted)]">
            <Wallet size={14} /> Current balance
          </span>
          <AnimatedAmount value={data.currentBalance} className="num text-[38px] font-semibold tracking-tight text-[var(--text)]" />
        </div>
      ...
      <div className="mb-4 flex flex-col gap-2 sm:mb-5 sm:grid sm:grid-cols-3 sm:gap-3">
      ...
      <div className="mb-4 grid gap-3 sm:mb-5 lg:grid-cols-2">
        <Card>
