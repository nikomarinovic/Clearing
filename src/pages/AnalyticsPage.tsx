    ...
    <div className="pb-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:gap-5 lg:grid-cols-2">
        <Card className="lg:col-span-2">
          <h2 className="mb-1 text-[15px] font-semibold text-[var(--text)]">Logging activity</h2>
          <p className="mb-4 text-[13px] text-[var(--text-muted)]">
            How consistently you're tracking transactions {"\u2014"} brighter days mean more logged.
          </p>
          <ActivityHeatmap />
        </Card>
